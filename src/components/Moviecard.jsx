...
function Moviecard({ movie }) {
  ...
  return (
    <motion.div
      ...
      exit={{ opacity: 1 }}
      layout
      className="card relative w-full md:w-60  drop-shadow-2xl shadow-2xl  shadow-[#e684f54b] h-[410px] md:h-[360px] my-3 mx-4 md:my-5 md:mx-0 cursor-pointer rounded-xl overflow-hidden"
    >
      {/* bookmark buttons */}
      <button
