        ...
        <>
          ...
          <div className="flex justify-center flex-wrap">
            <div className="text-white flex-wrap ">
              <h1 className="text-white font-semibold bg-gray-800 rounded-full px-4 py-1 m-2">
                Free Watch {moviedet.title}
              </h1>
              <h1 className="text-white font-semibold bg-gray-800 rounded-full px-4 py-1 m-2">
                {moviedet.title}
              </h1>
              <h1 className="text-white font-semibold bg-gray-800 rounded-full px-4 py-1 m-2">
                Free Download {moviedet.title}
              </h1>{" "}
              <h1 className="text-white font-semibold bg-gray-800 rounded-full px-4 py-1 m-2">
                Online Watch {moviedet.title}
              </h1>
            </div>
          </div>
          ...
          <div className="text-white flex-wrap max-w-[1100px] mx-auto  justify-center items-center flex ">
            <h1 className="text-white font-semibold bg-gray-800 rounded-full px-4 py-1 m-2">
              Free Watch {moviedet.title}
            </h1>
            <h1 className="text-white font-semibold bg-gray-800 rounded-full px-4 py-1 m-2">
          ...
          <div className="text-white flex-wrap max-w-[1100px] mx-auto  justify-center items-center flex ">
            <h1 className="text-white font-semibold bg-gray-800 rounded-full px-4 py-1 m-2">
              How to Download {moviedet.title}
            </h1>
            <h1 className="text-white font-semibold bg-gray-800 rounded-full px-4 py-1 m-2">
              Stream and Download {moviedet.title}
            </h1>{" "}
            <h1 className="text-white font-semibold bg-gray-800 rounded-full px-4 py-1 m-2">
              Download {moviedet.title} Now
            </h1>{" "}
            <h1 className="text-white font-semibold bg-gray-800 rounded-full px-4 py-1 m-2">
              Download {moviedet.title} in a Flash
            </h1>{" "}
            <h1 className="text-white font-semibold bg-gray-800 rounded-full px-4 py-1 m-2">
              Online Watch {moviedet.title}
            </h1>{" "}
